...
class AuthEventSubscriber
{
    ...
    /**
     * Handle login events for locked users.
     */
    public function onUserLoginIsLocked($event)
    {
        $this->describeUserEventAction($event, 'Locked User Tried Login', 'A locked user ', 'tried to login');
    }
    /**
    ...
    public function subscribe($events)
    {
        ...
        $events->listen(
            'App\Events\LoginNotActiveEvent',
            'App\Listeners\AuthEventSubscriber@onUserLoginNotActive'
        );
        $events->listen(
            'App\Events\UserLoginIsLocked',
            'App\Listeners\AuthEventSubscriber@onUserLoginIsLocked'
        );
        $events->listen(
            'App\Events\LoginFailedEvent',
