...
let CreateMinistryComponent = class CreateMinistryComponent {
...
let EditMinistryComponent = class EditMinistryComponent {
    constructor(formBuilder, route, router, ministryManagementService) {
        this.formBuilder = formBuilder;
        this.route = route;
        this.router = router;
        this.ministryManagementService = ministryManagementService;
    ...
    getMinistryById(id) {
        ...
        this.ministryManagementService.getMinistryByID(id, 'states').subscribe((data) => {
            this.ministry = data.data;
            this.states = data.states;
            this.pageLoading = false;
            if (this.ministry.address) {
                this.changeCities(this.ministry.address.state_id);
            }
            this.UpdateMinistryForm.patchValue({
                name: this.ministry.name,
                code: this.ministry.code,
                email: this.ministry.email,
                phone: this.ministry.phone,
                state_id: this.ministry.address ? this.ministry.address.state_id : '',
                city_id: this.ministry.address ? this.ministry.address.city_id : '',
                state: this.ministry.address ? this.ministry.address.state : '',
                city: this.ministry.address ? this.ministry.address.city : '',
                address_line_1: this.ministry.address ? this.ministry.address.address_line_1 : '',
                address_line_2: this.ministry.address ? this.ministry.address.address_line_2 : '',
                pobox_number: this.ministry.address ? this.ministry.address.pobox_number : ''
            });
        }, (err) => {
    ...
    onSubmit(value) {
        ...
        this.loading = true;
        if (value.id) {
            this.ministryManagementService.updateMinistry(value).subscribe((ministry) => {
                if (ministry) {
...
const routes = [
    ...
    { path: 'parastatals',
        loadChildren: () => __webpack_require__.e(/*! import() | app-pages-institution-parastatal-parastatal-module */ "app-pages-institution-parastatal-parastatal-module").then(__webpack_require__.bind(null, /*! app/pages/institution/parastatal/parastatal.module */ "./src/app/pages/institution/parastatal/parastatal.module.ts")).then(m => m.ParastatalModule),
...
let MinistryListComponent = class MinistryListComponent {
    constructor(ministryManagementService, router) {
        this.ministryManagementService = ministryManagementService;
        this.router = router;
        this.errorMessage = '';
    ...
    getMinistries() {
        ...
        this.errorMessage = '';
        this.ministries = [];
        this.ministryManagementService.getMinistries(this.queryString).subscribe((ministries) => {
    ...
    deleteMinistry(id, index) {
        sweetalert2__WEBPACK_IMPORTED_MODULE_2___default.a.fire({
            ...
            if (willDelete.value) {
                this.ministryManagementService.deleteMinistry(id).subscribe(deleted => {
...
//# sourceMappingURL=app-pages-institution-institution-module-es2015.js.map