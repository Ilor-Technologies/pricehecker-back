...
var CategoriesListComponent = /** @class */ (function () {
    function CategoriesListComponent(service, router, formBuilder) {
    ...
    CategoriesListComponent.prototype.submitSearch = function () {
    ...
    CategoriesListComponent.prototype.searchGoodsCategory = function (url, params) {
        var _this = this;
        this.searching = true;
        this.data = [];
        this.last_page = -1;
        this.service.getAllGoodsCategory(url, params).subscribe(function (data) {
            ...
            _this.totalItem = _this.data.length;
    ...
    CategoriesListComponent.prototype.handleDelete = function () {
        var _this = this;
        var text = 'Do you want to delete ' + (this.dataSelection.length === 1 ? 'the selected category' : 'the categories selected');
    ...
    CategoriesListComponent.prototype.showDeleteSingleModal = function (id) {
        // deselect all boxes
        this.toggleAll(false);
        this.dataSelection = [id];
        this.handleDelete();
    };
    CategoriesListComponent.prototype.doDelete = function () {
        var _this = this;
        ...
        if (this.dataSelection.length === 1) {
            this.service.deleteCategory(this.dataSelection[0]).subscribe(function (data) {
                if (data) {
                    _app_constants__WEBPACK_IMPORTED_MODULE_5__["Constants"].succeeded('The category was deleted successfully!').then(function (response) {
                        _this.submitSearch();
                    });
                }
            }, function (err) { return _app_constants__WEBPACK_IMPORTED_MODULE_5__["Constants"].handleError(err, _this.router, true); });
        }
        else if (this.dataSelection.length) {
            for (var x = 0; x < this.dataSelection.length; x++) {
                parems.push(this.dataSelection[x].id);
            }
            this.service.deleteCategories(parems).subscribe(function (data) {
                if (data) {
                    _app_constants__WEBPACK_IMPORTED_MODULE_5__["Constants"].succeeded('The selected categories were deleted successfully!').then(function (response) {
                        _this.submitSearch();
                    });
                }
            }, function (err) {
    ...
    CategoriesListComponent.prototype.toggleSelect = function (target, item) {
        if (target.checked) {
    ...
    CategoriesListComponent.prototype.toggleAll = function (value) {
        var d = $('.select-box').prop('checked', !value);
        if (value) {
            this.dataSelection = [];
        }
        d.click();
...
var CreateCategoryComponent = /** @class */ (function () {
    function CreateCategoryComponent(service, formBuilder, router, goodsService) {
        this.service = service;
        this.formBuilder = formBuilder;
        this.router = router;
    ...
    CreateCategoryComponent.prototype.loadCategories = function () {
        var _this = this;
    ...
    CreateCategoryComponent.prototype.onSubmit = function (_a) {
        var _this = this;
        ...
        //  console.log(value);
        this.service.addNew(value).subscribe(function (resp) {
            _this.loading = false;
            if (resp) {
    ...
    CreateCategoryComponent.prototype.addNewProperty = function () {
        this.properties.push({ name: '', type: '' });
    };
    CreateCategoryComponent.prototype.removeProperty = function (property) {
...
var EditCategoryComponent = /** @class */ (function () {
    function EditCategoryComponent(service, formBuilder, router, route) {
        this.service = service;
        this.formBuilder = formBuilder;
        this.router = router;
        this.route = route;
    ...
    EditCategoryComponent.prototype.buildForm = function () {
        this.form = this.formBuilder.group({
    ...
    EditCategoryComponent.prototype.loadData = function () {
        var _this = this;
        this.pageLoading = true;
        this.service.getGoodsCategory(this.currentId).subscribe(function (data) {
            _this.pageLoading = false;
            if (!data) {
                return;
            }
            console.log(data);
            _this.categoryData = data.category;
            _this.data = data.others;
            _this.form.patchValue({
                name: _this.categoryData.name,
                description: _this.categoryData.description,
                meta_description: _this.categoryData.meta_description,
                meta_keyword: _this.categoryData.meta_keyword,
                parent_id: _this.categoryData.parent_id,
            });
            _this.properties = [];
            if (_this.categoryData.properties_template) {
                _this.categoryData.properties_template.forEach(function (property) {
    ...
    EditCategoryComponent.prototype.onSubmit = function (_a) {
        var _this = this;
        var value = _a.value, valid = _a.valid;
        this.loading = true;
        this.errorMessage = '';
        this.successMessage = '';
        value.properties = JSON.stringify({ data: this.properties });
        this.service.updateCategory(this.currentId, value).subscribe(function (resp) {
            if (resp) {
                sweetalert2__WEBPACK_IMPORTED_MODULE_2___default.a.fire('Updated!', 'Goods category updated successfully!', 'success');
                _this.router.navigate(['/app/goods-categories']);
            }
            _this.loading = false;
        }, function (err) {
    ...
    EditCategoryComponent.prototype.addNewProperty = function () {
        this.properties.push({ name: '', type: '' });
    };
    EditCategoryComponent.prototype.removeProperty = function (property) {
        this.properties.splice(this.properties.indexOf(property), 1);
    };
...
//# sourceMappingURL=app-pages-category-category-module-es5.js.map