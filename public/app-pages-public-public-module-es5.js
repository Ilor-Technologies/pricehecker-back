...
var FaqComponent = /** @class */ (function () {
    ...
    FaqComponent.prototype.getFaq = function () {
        var _this = this;
        this.loading = true;
        this.faqService.getFaqsGuest().subscribe(function (faqs) {
            _this.faqs = faqs;
            _this.loading = false;
        }, function (err) {
            _this.loading = false;
...
var FeedbackComponent = /** @class */ (function () {
    function FeedbackComponent(formBuilder, router, route, feedbacksService, changeDetectorRef, elem, _location) {
    ...
    FeedbackComponent.prototype.backClicked = function () {
        this._location.back();
    };
    ...
    FeedbackComponent.prototype.onSubmit = function (_a) {
        var _this = this;
...
//# sourceMappingURL=app-pages-public-public-module-es5.js.map