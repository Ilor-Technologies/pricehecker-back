...
var AddGradeComponent = /** @class */ (function () {
    function AddGradeComponent(formBuilder, router, route, gradesService) {
    ...
    AddGradeComponent.prototype.ngOnInit = function () {
        this.buildForm();
    };
    AddGradeComponent.prototype.buildForm = function () {
    ...
    AddGradeComponent.prototype.onSubmit = function (_a) {
        var _this = this;
...
var EditGradeComponent = /** @class */ (function () {
    function EditGradeComponent(formBuilder, router, route, gradesService) {
        this.formBuilder = formBuilder;
        this.router = router;
        this.route = route;
        this.gradesService = gradesService;
    ...
    EditGradeComponent.prototype.ngOnInit = function () {
        this.buildForm();
        var id = this.route.snapshot.params['id'];
        this.getGrade(id);
    };
    EditGradeComponent.prototype.buildForm = function () {
    ...
    EditGradeComponent.prototype.getGrade = function (id) {
        var _this = this;
        this.pageLoading = true;
        this.gradesService.getGradeByID(id)
            .subscribe(function (grade) {
            _this.grade = grade;
            _this.gradeForm.patchValue({
                level: grade.level,
    ...
    EditGradeComponent.prototype.onSubmit = function (_a) {
        var _this = this;
        var value = _a.value, valid = _a.valid;
    ...
    EditGradeComponent.prototype.onDelete = function (event) {
        var _this = this;
        ...
        _app_constants__WEBPACK_IMPORTED_MODULE_4__["Constants"].confirm({
            ...
            if (willDelete.value) {
                _this.gradesService.deleteGrade(_this.grade.id)
                    .subscribe(function (status) {
                    if (status) {
                        _this.router.navigate(['/app/grades']);
                    }
                    else {
...
var GradeComponent = /** @class */ (function () {
    function GradeComponent(gradesService, route, router) {
        this.gradesService = gradesService;
        this.route = route;
        this.router = router;
        this.grades = [];
    ...
    GradeComponent.prototype.getGrade = function (search) {
        var _this = this;
        this.loading = true;
        this.grades = [];
        this.gradesService.getGrades(search).subscribe(function (grades) {
            _this.grades = grades.grades || [];
            _this.loading = false;
        }, function (err) {
    ...
    GradeComponent.prototype.deleteGrade = function (id) {
        var _this = this;
        _app_constants__WEBPACK_IMPORTED_MODULE_3__["Constants"].confirm({
            ...
            if (willDelete.value) {
                _this.gradesService.deleteGrade(id).subscribe(function (status) {
                    if (status) {
...
//# sourceMappingURL=app-pages-grade-grade-module-es5.js.map