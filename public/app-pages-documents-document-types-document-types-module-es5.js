...
var AddDocumentTypeComponent = /** @class */ (function () {
    function AddDocumentTypeComponent(formBuilder, router, route, documentTypeService) {
        this.formBuilder = formBuilder;
        this.router = router;
        this.route = route;
        this.documentTypeService = documentTypeService;
    }
    AddDocumentTypeComponent.prototype.ngOnInit = function () {
        this.buildForm();
    };
    AddDocumentTypeComponent.prototype.buildForm = function () {
    ...
    AddDocumentTypeComponent.prototype.onSubmit = function (_a) {
        var _this = this;
        var value = _a.value, valid = _a.valid;
        if (value) {
            this.loading = true;
            this.documentTypeService.addDocType(value).subscribe(function (document_type) {
                if (document_type) {
                    _this.router.navigate(['/app/document-types']);
                }
                _this.loading = false;
            }, function (err) {
    ...
    return AddDocumentTypeComponent;
}());
...
var DocumentTypesComponent = /** @class */ (function () {
    function DocumentTypesComponent(documentTypeService, route, _Location, router) {
        this.documentTypeService = documentTypeService;
        this.route = route;
    ...
    DocumentTypesComponent.prototype.checkAll = function (ev) {
        this.doc_types.forEach(function (x) { return x.selected = ev.target.checked; });
    };
    Object.defineProperty(DocumentTypesComponent.prototype, "isAllChecked", {
        get: function () {
            return this.doc_types.every(function (_) { return _.selected; });
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(DocumentTypesComponent.prototype, "hasSomeChecked", {
        get: function () {
            return this.doc_types.find(function (e) { return e.selected; });
        },
        enumerable: true,
        configurable: true
    });
    DocumentTypesComponent.prototype.getDocTypes = function (filter) {
        var _this = this;
        this.loading = true;
        this.doc_types = [];
        this.documentTypeService.getDocumentTypes(filter).subscribe(function (doc_types) {
            _this.doc_types = doc_types;
            _this.loading = false;
        }, function (err) {
    ...
    DocumentTypesComponent.prototype.deleteDocType = function (id) {
        var _this = this;
        sweetalert2__WEBPACK_IMPORTED_MODULE_6___default.a.fire({
            ...
            if (willDelete.value) {
                _this.documentTypeService.deleteDocumentType(id).subscribe(function (status) {
                    if (status) {
...
var DocumentTypesModule = /** @class */ (function () {
    function DocumentTypesModule() {
    }
...
var EditDocumentTypeComponent = /** @class */ (function () {
    function EditDocumentTypeComponent(formBuilder, router, route, documentTypeService) {
        this.formBuilder = formBuilder;
        this.router = router;
        this.route = route;
        this.documentTypeService = documentTypeService;
    ...
    EditDocumentTypeComponent.prototype.ngOnInit = function () {
        this.buildForm();
        var id = this.route.snapshot.params['id'];
        this.getDocumentType(id);
    };
    EditDocumentTypeComponent.prototype.buildForm = function () {
        this.TypeForm = this.formBuilder.group({
            name: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].maxLength(255)])],
            description: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].maxLength(255)])],
        });
    };
    EditDocumentTypeComponent.prototype.getDocumentType = function (id) {
        var _this = this;
        this.pageLoading = true;
        this.documentTypeService.getDocumentTypeByID(id).subscribe(function (doc_type) {
            _this.doc_type = doc_type;
            _this.TypeForm.patchValue({
                name: _this.doc_type.name,
                description: _this.doc_type.description,
            });
    ...
    EditDocumentTypeComponent.prototype.onSubmit = function (_a) {
        var _this = this;
        var value = _a.value, valid = _a.valid;
        ...
        if (value.id) {
            this.documentTypeService.updateDocumentType(value)
                .subscribe(function (doc_type) {
                if (_this.doc_type) {
                    _this.onSuccess = 'Document Type successfully updated';
                }
            }, function (err) {
    ...
    EditDocumentTypeComponent.prototype.onDelete = function (event) {
        var _this = this;
    ...
    return EditDocumentTypeComponent;
}());
...
//# sourceMappingURL=app-pages-documents-document-types-document-types-module-es5.js.map