...
var CreateWarehouseComponent = /** @class */ (function () {
    function CreateWarehouseComponent(vendorDataService, router, formBuilder) {
    ...
    CreateWarehouseComponent.prototype.buildForm = function () {
    ...
    CreateWarehouseComponent.prototype.onSubmit = function () {
        var _this = this;
        this.loading = true;
        this.errorMessage = '';
        this.vendorDataService.addWarehouse(this.newForm.value).subscribe(function (resp) {
    ...
    CreateWarehouseComponent.prototype.getStates = function () {
        var _this = this;
        this.vendorDataService.getStates().subscribe(function (states) {
            _this.states = states;
        }, function (err) {
            _app_constants__WEBPACK_IMPORTED_MODULE_2__["Constants"].handleError(err, _this.router, true);
        });
    };
    CreateWarehouseComponent.prototype.changeCities = function (v) {
        var _this = this;
        this.cities = [];
...
var EditWarehouseComponent = /** @class */ (function () {
    function EditWarehouseComponent(vendorDataService, router, route, formBuilder) {
        this.vendorDataService = vendorDataService;
        this.router = router;
        this.route = route;
        this.formBuilder = formBuilder;
    ...
    EditWarehouseComponent.prototype.ngOnInit = function () {
        var warehouse_id = this.route.snapshot.params['id'];
        this.getStates();
        this.getWarehouse(warehouse_id);
        this.buildForm();
    };
    EditWarehouseComponent.prototype.buildForm = function () {
    ...
    EditWarehouseComponent.prototype.getWarehouse = function (warehouse_id) {
        var _this = this;
        this.pageLoading = true;
        this.vendorDataService.getWarehouseByID(warehouse_id).subscribe(function (warehouse) {
            ...
            _this.updateWarehouseForm.patchValue({
                name: _this.warehouse.name,
                address_line_1: _this.warehouse.address ? _this.warehouse.address.address_line_1 : '',
                address_line_2: _this.warehouse.address ? _this.warehouse.address.address_line_2 : '',
                pobox_number: _this.warehouse.address ? _this.warehouse.address.pobox_number : '',
                state_id: _this.warehouse.address ? _this.warehouse.address.state_id : '',
                city_id: _this.warehouse.address ? _this.warehouse.address.city_id : ''
            });
            _this.pageLoading = false;
        }, function (err) {
    ...
    EditWarehouseComponent.prototype.onSubmit = function (_a) {
        var _this = this;
        var value = _a.value, valid = _a.valid;
        value.id = this.warehouse.id;
        this.loading = true;
        if (value.id) {
            this.vendorDataService.updateWarehouse(value).subscribe(function (warehouse) {
                if (warehouse) {
    ...
    EditWarehouseComponent.prototype.getStates = function () {
        var _this = this;
        this.vendorDataService.getStates().subscribe(function (states) {
            _this.states = states;
        }, function (err) {
    ...
    EditWarehouseComponent.prototype.changeCities = function (v) {
        var _this = this;
        this.cities = [];
...
var WarehouseListComponent = /** @class */ (function () {
    function WarehouseListComponent(formBuilder, vendorDataService, goodsService, router, mapsApiLoader) {
        this.formBuilder = formBuilder;
        this.vendorDataService = vendorDataService;
    ...
    Object.defineProperty(WarehouseListComponent.prototype, "permissions", {
        get: function () {
    ...
    WarehouseListComponent.prototype.can = function (permission) {
        return _services_auth_service__WEBPACK_IMPORTED_MODULE_10__["AuthService"].can(permission);
    };
    Object.defineProperty(WarehouseListComponent.prototype, "isVendor", {
        get: function () {
    ...
    WarehouseListComponent.prototype.loadVendors = function () {
        var _this = this;
        this.goodsService.getVendors().subscribe(function (vendors) {
            _this.vendors = vendors;
            if (_this.vendors.length < 1) {
                _this.errorMessage = 'No vendor available on this platform yet';
            }
        }, function (err) {
    ...
    //     });
    // }
    WarehouseListComponent.prototype.getWarehouses = function (params) {
        var _this = this;
        this.searching = true;
        this.errorMessage = '';
        this.vendorDataService.getWarehousesWithParam(params).subscribe(function (warehouses) {
            _this.locations = [];
            if (warehouses) {
            ...
            if (_this.warehouses.length) {
                _this.errorMessage = '';
            }
            else {
                _this.errorMessage = 'No result to show';
            }
    ...
    WarehouseListComponent.prototype.submitSearch = function () {
        ...
        if (!this.isVendor) {
            var vendor = this.searchForm.get('vendor_id').value;
            if (!vendor) {
    ...
    WarehouseListComponent.prototype.deleteWarehouse = function (warehouse, i) {
        var _this = this;
        this.errorMessage = '';
        sweetalert2__WEBPACK_IMPORTED_MODULE_3___default.a.fire({
            ...
            if (willDelete.value) {
                _this.vendorDataService.deleteWarehouse(warehouse.id).subscribe(function (response) {
                    _this.warehouses.splice(i, 1);
