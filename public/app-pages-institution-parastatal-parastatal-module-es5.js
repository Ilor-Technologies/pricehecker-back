...
var CreateParastatalComponent = /** @class */ (function () {
    function CreateParastatalComponent(formBuilder, ministryManagementService, router) {
    ...
    CreateParastatalComponent.prototype.ngOnInit = function () {
        this.buildForm();
        this.getStates();
    };
    CreateParastatalComponent.prototype.buildForm = function () {
    ...
    CreateParastatalComponent.prototype.changeCities = function (value) {
        this.cities = [];
        if (value) {
    ...
    CreateParastatalComponent.prototype.getStates = function () {
        var _this = this;
        this.ministryManagementService.getStates().subscribe(function (states) {
            _this.states = states;
        });
    };
    CreateParastatalComponent.prototype.onSubmit = function (value) {
        var _this = this;
        this.loading = true;
        var subscriber = this.ministryManagementService.addParastatal(value);
        if (this.editMode) {
            subscriber = this.ministryManagementService.updateParastatal(this.editData.id, value);
        }
        subscriber.subscribe(function (parastatal) {
            if (parastatal) {
    ...
    return CreateParastatalComponent;
}());
...
var MinsitryParastatalComponent = /** @class */ (function () {
    function MinsitryParastatalComponent(ministryManagementService, route, router) {
        this.ministryManagementService = ministryManagementService;
        this.route = route;
        this.router = router;
        this.errorMessage = '';
    ...
    MinsitryParastatalComponent.prototype.ngOnInit = function () {
        var id = this.route.snapshot.params['id'];
        this.getMinistryById(id);
        this.institution_id = id;
    };
    MinsitryParastatalComponent.prototype.getMinistryById = function (id) {
        var _this = this;
        this.pageLoading = true;
        this.errorMessage = '';
        this.ministryManagementService.getMinistryByID(id).subscribe(function (ministry) {
            _this.ministry = ministry;
    ...
    MinsitryParastatalComponent.prototype.editParastatal = function (parastatal) {
    };
    MinsitryParastatalComponent.prototype.deleteParastatal = function (id, i) {
        var _this = this;
        sweetalert2__WEBPACK_IMPORTED_MODULE_2___default.a.fire({
            ...
            if (willDelete.value) {
                _this.ministryManagementService.deleteParastatal(id).subscribe(function (deleted) {
                    sweetalert2__WEBPACK_IMPORTED_MODULE_2___default.a.fire('Deleted!', 'Institution has been deleted!', 'success');
                    _this.ministry.parastatals.splice(i, 1);
                }, function (err) {
    ...
    return MinsitryParastatalComponent;
}());
...
var ParastatalModule = /** @class */ (function () {
    function ParastatalModule() {
    }
...
//# sourceMappingURL=app-pages-institution-parastatal-parastatal-module-es5.js.map