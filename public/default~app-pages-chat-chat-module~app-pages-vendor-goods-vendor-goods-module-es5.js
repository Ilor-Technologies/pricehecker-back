...
var LightBoxComponent = /** @class */ (function () {
    function LightBoxComponent(chatService) {
    ...
    LightBoxComponent.prototype.open = function (index) {
        if (index === void 0) { index = this.slideIndex; }
        this.show = true;
        this.toSlide(index);
    };
    ;
    ...
    ;
    LightBoxComponent.prototype.changeSlide = function (n) {
        this.toSlide((this.slideIndex + n));
    };
    ;
    LightBoxComponent.prototype.toSlide = function (n) {
    ...
    ;
    LightBoxComponent.prototype.getExtension = function (path) {
...
var UploadComponent = /** @class */ (function () {
    function UploadComponent(authService, uploadService, http, router) {
        var _this = this;
        ...
        this.uploadService.trigger.subscribe(function (command) {
            if (_this.id === command) {
                var button = document.getElementById('upload-file-input-' + _this.id);
                if (button) {
                    button.nodeValue = '';
                    button.click();
                }
    ...
    UploadComponent.prototype.uploadFile = function (event) {
        ...
        if (this.fileType) {
            var extension = _data__WEBPACK_IMPORTED_MODULE_6__["AppData"].FILETYPES[this.fileType];
        ...
        this.http.post(_app_constants__WEBPACK_IMPORTED_MODULE_5__["Constants"].url + this.serverUrlRoute, formData, { reportProgress: true, observe: 'events', headers: _app_constants__WEBPACK_IMPORTED_MODULE_5__["Constants"].getUploadHeader() }).subscribe(function (evt) {
            if (evt.type === _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpEventType"].UploadProgress) {
                ...
                _this.updateUploadStatus.emit({ type: 'progress', value: _this.progress });
            }
            else if (evt.type === _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpEventType"].Response) {
                var upload = evt.body.picture;
                ...
                _this.uploadFinished.emit(upload);
                oldEvent.target.value = '';
            }
        }, function (error) {
            _this.uploading.status = false;
            _app_constants__WEBPACK_IMPORTED_MODULE_5__["Constants"].handleError(error, _this.router, true);
            _this.message = '';
            oldEvent.target.value = '';
            _this.updateUploadStatus.emit({ type: 'error', value: _this.progress });
        });
    };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
//# sourceMappingURL=default~app-pages-chat-chat-module~app-pages-vendor-goods-vendor-goods-module-es5.js.map