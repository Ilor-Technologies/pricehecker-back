...
You don't have to worry about authentication and password recovery anymore. I created four controllers you can find in the `App\Api\Controllers` for those operations.
